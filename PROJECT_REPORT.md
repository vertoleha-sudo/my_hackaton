...
- Базовые классы: `src/system/` (security_monitor, custom_process, event_types и тд)
...
2. ✅ **Пользователи могут выполнять в своих программах только разрешенные операции**
   - Проверка прав в UserProgramExecutor
   - Проверка политик в мониторе безопасности
   - Многоуровневая защита

3. ✅ **Спутник не делает фотографии запрещенных районов**
   - Проверка координат снимков в OpticsControl
   - Блокировка отображения снимков в запрещённых зонах
   - Синхронизация зон с RestrictedZoneControl

4. ✅ **Орбита спутника всегда остается в рамках заданных ограничений**
   - Валидация границ орбиты в OrbitControl (200_000 - 2_000_000 м)
   - Блокировка опасных значений независимо от источника

**Подробный анализ:** См. `SECURITY_GOALS_COMPLIANCE.md`
...
- Соответствие целям безопасности: `SECURITY_GOALS_COMPLIANCE.md`
